...
if inference_mode == None:
    ...
    for epoch in range(1):
        ...
        for batch_idx , (reflect_image , clean_image , name) in enumerate(train_dataloader):
            with torch.no_grad():
                ...
                plt.imsave(rf'C:\Users\Admin\Desktop\Reflection_removal\Output\{batch_idx_X}.png' , np.transpose(
